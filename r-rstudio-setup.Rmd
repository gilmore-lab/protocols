...
Global Protect is the recommended VPN client.
If you do not have Global Connect installed, visit here for [Windows](https://ithelp.ssri.psu.edu/penn-state-vpn) and [Mac](https://ithelp.ssri.psu.edu/penn-state-vpn-mac) installation instructions.

1. Log on to PSU TLT's RStudio server instance using your PSU access ID (e.g., `rog1` and password):

<https://rstudio.tlt.psu.edu/auth-sign-in>
