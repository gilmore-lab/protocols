...
2. Log in to R Studio
    ...
    - Scroll down to the RStudio Server Section  
     ...
     ![R Studio Server Section](../protocols/imgs/RStudio-ServerInfo.png)  
...
![Clone with HTTPS](../protocols/imgs/GitHub-copy-repo-https.png)  
...
![Git Window in R](../protocols/imgs/Git-Window-R.png)  
