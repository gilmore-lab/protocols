...
````
{{r,< video https://www.youtube.com/embed/66oNv_DJuPc
    title="Data Sharing and Management Snafu in 3 Short Acts https://youtu.be/66oNv_DJuPc" >}}
````
...
{{< video https://www.youtube.com/embed/66oNv_DJuPc title="Data Sharing and Management Snafu in 3 Short Acts https://youtu.be/66oNv_DJuPc" >}}
...
### Generate a QR code
 Make sure library `qrcode` is installed
 
qr_code("https://webaddress.html") |>
  generate_svg(
    "/img/src/include/img/NAMEofQRcode.svg",
